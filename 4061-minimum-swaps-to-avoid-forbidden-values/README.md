<h2><a href="https://leetcode.com/problems/minimum-swaps-to-avoid-forbidden-values">Minimum Swaps to Avoid Forbidden Values</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given two integer arrays, <code>nums</code> and <code>forbidden</code>, each of length <code>n</code>.</p>
