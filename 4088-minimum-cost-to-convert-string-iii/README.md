<h2><a href="https://leetcode.com/problems/minimum-cost-to-convert-string-iii">Minimum Cost to Convert String III</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given two strings, <code>source</code> and <code>target</code>.</p>
