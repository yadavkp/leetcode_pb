<h2><a href="https://leetcode.com/problems/transform-binary-string-using-subsequence-sort">Transform Binary String Using Subsequence Sort</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given a <span data-keyword="binary-string">binary string</span> <code>s</code>.</p>
...
<ul>
	<li>Choose any <span data-keyword="subsequence-string">subsequence</span> <code>sub</code> of <code>s</code>.</li>
